...
class FineTune(object):
    ...
    def _step(self, model, data, n_iter, mol_idx, shuffle_idx, motif_samples):
        # get the prediction
        __, pred = model(data, mol_idx, shuffle_idx, motif_samples)
    ...
    def train(self):
        ...
        for epoch_counter in range(self.config['epochs']):
            for bn, data in enumerate(train_loader):
                ...
                loss = self._step(model, data, n_iter,  mol_idx, shuffle_idx, motif_samples)
    ...
    def _validate(self, model, valid_loader, motif_emb_tensor, clique_list, mol_to_clique):
        ...
        with torch.no_grad():
            ...
            for bn, data in enumerate(valid_loader):
                ...
                __, pred = model(data, mol_idx, shuffle_idx, motif_samples)
                loss = self._step(model, data, bn, mol_idx, shuffle_idx, motif_samples)
